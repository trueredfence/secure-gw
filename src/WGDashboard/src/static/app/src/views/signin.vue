...
<template>
  ...
  >
    <div class="login-box m-auto">
      <div class="m-auto" style="width: 700px">
        ...
        <span class="dashboardLogo display-3"
          ><strong>WGDashboard</strong></span
        >
        <div
        ...
        >
          ...
          <div class="form-group text-body">
            <label for="password" class="text-left" style="font-size: 1rem"
          ...
          <div class="form-group text-body" v-if="totpEnabled">
            <label for="totp" class="text-left" style="font-size: 1rem"
              ><i class="bi bi-lock-fill"></i
            ></label>
            <SignInTOTP :data="this.data"></SignInTOTP>
          </div>
          <button
            class="btn btn-lg btn-dark ms-auto mt-5 w-100 d-flex btn-brand signInBtn"
    ...
    <small class="text-muted pb-3 d-block w-100 text-center mt-3">
      ...
      <a href="https://github.com/trueredfence/" target="_blank"
        ><strong>Redfence</strong></a
      >
    </small>
    <div class="messageCentre text-body position-absolute end-0 m-3">
      <TransitionGroup name="message" tag="div" class="position-relative">
        <Message
          v-for="m in getMessages.slice().reverse()"
          :message="m"
          :key="m.id"
        ></Message>
      </TransitionGroup>
